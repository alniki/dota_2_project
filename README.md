...
* Получение данных об открытых матчах с OpenDota API, загрузка ~ 20 тыс матчей
* Знакомство и обработка данных в Jupyter Notebook, исследовательский анализ данных EDA
* Создание базы данных PostgreSQL
* Создание материализованных представлений для ускорения работы BI-системы
* Построение аналитической панели для визуализации найденных закономерностей в Yandex DataLens 
* Создание ETL пайплана
...
Загрузка CSV файлов, подготовленных на ранних этапах в базу данных
...
- Ссылка на дашборд: https://datalens.ru/kv8lvzzuoft65?tab=25q
